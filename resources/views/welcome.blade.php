        ...
        <header class="not-has-[nav]:hidden mb-6 w-full max-w-[335px] lg:max-w-4xl text-sm">
            @if (Route::has('login'))
                <nav class="flex justify-end items-center gap-4">
                    ...
                    @else
                        <a href="{{ route('login') }}"
                            class="inline-block px-5 py-1.5 border border-transparent hover:border-[#19140035] dark:hover:border-[#3E3E3A] rounded-sm text-[#1b1b18] dark:text-[#EDEDEC] text-sm leading-normal">
                            Log in
                        </a>
                    ...
                    <ul class="flex gap-3 text-sm leading-normal">
                        <li>
                            <a href="https://cloud.laravel.com" target="_blank"
                                class="inline-block bg-[#1b1b18] hover:bg-black dark:bg-[#eeeeec] dark:hover:bg-white px-5 py-1.5 border border-black hover:border-black dark:border-[#eeeeec] dark:hover:border-white rounded-sm text-white dark:text-[#1C1C1A] text-sm leading-normal">
                                Deploy now
                            </a>
                        </li>
                    </ul>
